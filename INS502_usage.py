...
def gM():
    ...
    command_response = parser.decode(cmd, 
        b'\x04\x01\x04\xc1 \x07\x8b\x02\x04!]=\x89\x03\x18INS502 8350-5020-01 v1.0\x04\x01\x00')
        # bytes([
        # 0x05, 
        # 0x00, 0x08, 0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,
        # 0x01, 0x04, 0x21, 0x3d, 0x89, 0x03,
        # 0x02, 0x04, 0x21, 0x3d, 0x89, 0x03,
        # 0x03, 0x02, 0x55, 0x55,
        # 0x04, 0x01, 0x00
        # ])
    return cmd, command_bytes, command_response
