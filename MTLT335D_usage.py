import sys
import struct
from acenav_api import create_parser,PacketParser
...
class CommandBuilder:
    ...
    def create(self, command_name: str, *args):
        ...
        request_frame_id = struct.unpack('<I', bytes(cmd_config.request_packet))[0]
...
command_definitions = [
    ...
    ['getPeriodicDataControlSettings', [0xFF56, 0x00], bytes([0x80, 0x01, 0x01, 0x01])],
